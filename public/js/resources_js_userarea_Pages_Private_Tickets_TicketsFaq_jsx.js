"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_userarea_Pages_Private_Tickets_TicketsFaq_jsx"],{

/***/ "./resources/js/userarea/Pages/Private/Tickets/TicketsFaq.jsx":
/*!********************************************************************!*\
  !*** ./resources/js/userarea/Pages/Private/Tickets/TicketsFaq.jsx ***!
  \********************************************************************/
...
var TicketsFaq = /*#__PURE__*/function (_Component) {
  _inherits(TicketsFaq, _Component);
  ...
  function TicketsFaq() {
    ...
    _defineProperty(_assertThisInitialized(_this), "faqs", [{
      ...
      answer: "بخش پشتیبانی تلفنی دایا آرتز در روز های شنبه تا پنجشنبه از ساعت 8 تا 20 و در روز جمعه از ساعت 9 تا 20 فعال است . البته در شبکه های اجتماعی و راه های ارتباطی آنلاین دایا آرتز تمام وقت تلاش بر نظارت و پاسخگویی دارد . فراموش نکنید دایا آرتز: پیکسل به پیکسل با شماست."
    }, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TicketsFaq);
