...
class PhoneInput extends Component {
    ...
    render() {
        let { value, title, path, name, onChangeHandler, phone_type } = this.props, { type } = this.state
        return (
            <div className="field-item col-12 col-md-6">
                ...
                <div className="input-group ltr animated">
                    ...
                    <input type="tel" value={value ?? ""} className="form-control ltr" placeholder={type === "cellphone" ? "شماره موبایل" : "شماره تلفن"} onChange={(e) => onChangeHandler(path, name, e.target.value, true)} />
                </div>
            </div>
        );
    }
