...
<div class="section w-100 text-center contact-us-section-2">
    ...
    <div class="contact-ways-container w-100 mb-5">
        <div class="text-center mb-4 col-10 col-md-3">
            <span><i class="contact-way-icon fas fa-phone mb-5 mt-5"></i></span>
            <div>
        ...
        <div class="text-center mb-4 col-10 col-md-3">
            <span><i class="contact-way-icon fab fa-battle-net mb-5 mt-5"></i></span>
            <div>
        ...
        <div class="text-center mb-4 col-10 col-md-3 mb-4">
            <span><i class="contact-way-icon fas fa-robot mb-5 mt-5"></i></span>
            <div>
