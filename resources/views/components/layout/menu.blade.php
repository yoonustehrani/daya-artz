<nav class="h-14 w-full py-2 px-6 bg-gradient-to-r from-indigo-500 to-indigo-700 flex flex-nowrap justify-between relative z-20 overflow-hidden">
    ...
    <div class="flex items-center flex-nowrap">
        <a href="#order_page" class="rounded-full py-0.5 px-4 border-2 border-slate-50 text-slate-50 duration-300 hover:border-transparent hover:bg-slate-50 hover:text-indigo-500 text-lg flex justify-center items-center group">
            <i class="far fa-plus text-slate-50 ml-2 text-lg group-hover:text-indigo-500 duration-300"></i>
            سفارش
        </a>
