<div class="footer-content w-100">
    ...
    <div class="col-12 float-left px-3 footer-info-container">
        ...
        <div class="col-lg-2 col-sm-6 col-12">
            ...
            <div>
                <ul class="text-right p-0 mb-4 footer-phones">
                    <li><i class="far fa-phone-office"></i><a href="tel:+982128423542">021 2842 3542</a></li>
                    <li><i class="far fa-mobile"></i><a href="tel:+989015045025">0901 504 5025</a></li>
                    <li><i class="far fa-mobile"></i><a href="tel:+989016045025">0901 604 5025</a></li>
                </ul>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6 col-12">
            ...
            <div class="mb-4 social-media-rows">
                ...
                <div class="social-media-container">
                    <a href="https://www.linkedin.com/company/dayaartz/"><i class="fab fa-linkedin-in"></i></a>
                    <a href="https://wa.me/989016045025"><i class="fab fa-whatsapp ml-4"></i></a>
                </div>
            </div>
