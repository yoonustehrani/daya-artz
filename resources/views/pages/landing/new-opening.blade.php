    ...
    <section class="w-full mt-3 flex flex-col items-center">
        ...
        <div class="bg-paper rounded-b-3xl shadow-lg mb-10 xl:w-10/12 p-6 break-words flex md:block flex-col items-center">
            ...
            <div class="px-5 pt-5 md:pt-[60px] text-lg leading-loose text-[#0102B5]">
                ...
                <p>مدیر فست فود محلی و کوچک و دنج
                    <span class="font-semibold">«همگر»</span>
                    با هدف جذب مشتری بیشتر به یک طراح گرافیک مراجعه می‌کند و از او می‌خواهد که برایش یک منو جدید و یک کارت ویزیت جذاب طراحی کند. این طراح گرافیک ناشناس هزینه طراحی های درخواست شده توسط مدیر فست فود «همگر» را بالای
                    <span class="underline underline-offset-[10px] text-red-600">5,000,000 تومان</span>    
                    برآورد می کند.
                </p>
                <br>
                <p>مدیر «همگر» پس از آشنایی با دایا آرتز و در میان گذاشتن هدف تبلیغاتی اش با کارشناسان ما لیست پیشنهادی زیر که شامل طراحی های مورد نیاز برای دستیابی به این هدف است را دریافت می کند :</p>
